...
$EMCC -o $BIN_DIR/lcms.js -I $INCLUDE_DIR $SRC_DIR/*.c -s EXPORTED_FUNCTIONS=["$exported_opt"] -s ASSERTIONS=1

$EMCC -o $BIN_DIR/lcms-O1.js -I $INCLUDE_DIR $SRC_DIR/*.c -s EXPORTED_FUNCTIONS=["$exported_opt"] -O1 -s ASSERTIONS=1
...
$EMCC -o $BIN_DIR/lcms-all.js -I $INCLUDE_DIR $SRC_DIR/*.c -s EXPORT_ALL=1 -s ASSERTIONS=1
